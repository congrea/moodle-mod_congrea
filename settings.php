...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('mod_congrea/recAllowpresentorAVcontrol', get_string('recAllowpresentorAVcontrol', 'congrea'),
                                                        get_string('recAllowpresentorAVcontrol_help', 'congrea'), 1));
     // Congrea recShowPresentorRecordingStatus default on.
    $settings->add(new admin_setting_configcheckbox('mod_congrea/recShowPresentorRecordingStatus', get_string('recShowPresentorRecordingStatus', 'congrea'),
                                                        get_string('recShowPresentorRecordingStatus_help', 'congrea'), 1));
    // Congrea recDisableAttendeeAV default off.
    $settings->add(new admin_setting_configcheckbox('mod_congrea/recDisableAttendeeAV', get_string('recDisableAttendeeAV', 'congrea'),
                                                        get_string('recDisableAttendeeAV_help', 'congrea'), 0));
     // Congrea recAllowattendeeAVcontrol default off.
    $settings->add(new admin_setting_configcheckbox('mod_congrea/recAllowattendeeAVcontrol', get_string('recAllowattendeeAVcontrol', 'congrea'),
                                                        get_string('recAllowattendeeAVcontrol_help', 'congrea'), 0));
    // Congrea recAllowattendeeAVcontrol default off.
    $settings->add(new admin_setting_configcheckbox('mod_congrea/showAttendeeRecordingStatus', get_string('showAttendeeRecordingStatus', 'congrea'),
