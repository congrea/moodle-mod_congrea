...
'poll_delete', 'poll_update', 'poll_result', 'poll_option_drop', 'file_save',
...
'congrea_get_enrolled_users', 'congrea_quiz','congrea_get_quizdata', 'congrea_add_quiz', 'congrea_quiz_result')));
