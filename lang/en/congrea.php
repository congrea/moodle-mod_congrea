...
$string['joinroomasstudent'] = 'Join virtual class room';
$string['joinroomasteacher'] = 'Join virtual class room as Presenter';
...
$string['teachername'] = 'Presenter: {$a->firstname} {$a->lastname}';
...
$string['askQuestion_help'] = 'If enabled, allow teacher and students to use Ask Question feature';
...
$string['min'] = 'Minutes';
$string['timeduration_help'] = 'Select the session duration that should be more than 10 minutes and less than 24 hours. If adding an Open session input value as \'0\'';
...
$string['cannotaddsession'] = 'Cannot add another session to this Congrea activity. To add session you need to first delete the Open-ended session and then add sessions again.';
$string['inifinitesessionnotallowed'] = 'This Congrea activity has timed sessions, so you are not allowed to add Open-ended session. In order to add Open-ended session, first delete all future schedules and then add.';
$string['informationtocreatesession'] = '<strong>Note</strong>: In a Congrea activity only one type of sessions can be created i.e. either an Open-ended session or Timed sessions. To create an Open-ended session in an Congrea activity input duration  as \'0\' and for timed sessions, input value greater than equal to 10 and less than 24 hours.';
...
$string['timeduration_help'] = 'Enter a value more than 10 if you want to create a session with a duration. For creating an Open-ended session with no closing time, enter 0.';
$string['onlyoneopensessionallowed'] = 'Only one Open-ended session canbe added per Congrea activity';
$string['opensession'] = 'infinite time.';
