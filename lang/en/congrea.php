...
$string['plandetails'] = 'Your plan details: {$a->rooms} rooms, {$a->users} users, {$a->storage} GB cloud storage';
...
$string['presenternameinschedules'] = 'Teacher';
...
$string['teachernameupcomingsessions'] = 'Teacher name';
$string['timedur'] = 'Time duration';
$string['dateandtime'] = 'Date and time';
$string['getfreeplan'] = 'Get Congrea free plan';
$string['7sessions'] = 'Next 7 sessions';
$string['30sessions'] = 'Next 30 sessions';
$string['90sessionss'] = 'Next 90 sessions';
$string['180sessions'] = 'Next 180 sessions'; 
$string['addmultiplesessions'] = 'Repeat this session';
$string['legacyplan'] = 'Congrea Legacy plan without recording';
$string['cannotadd'] = 'Cannot add another Open-ended session.';