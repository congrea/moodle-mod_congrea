...
$string['cannotaddsession'] = 'Cannot add another session to this Congrea activity. To add session you need to first delete the open session and then add sessions again.';
